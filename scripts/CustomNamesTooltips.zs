...
<mujmajnkraftsbettersurvival:itemsteelhammer:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<mujmajnkraftsbettersurvival:itemsteelspear:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<mujmajnkraftsbettersurvival:itemsteeldagger:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<mujmajnkraftsbettersurvival:itemsteelbattleaxe:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<mujmajnkraftsbettersurvival:itemsteelnunchaku:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
...
<bountifulbaubles:amuletsinwrath>.addTooltip(format.darkPurple(game.localize("tooltip.scripts.amuletSinWrath", "en_us")));
...
<contenttweaker:blood_tear>.addTooltip(format.gold(game.localize("item.contenttweaker.blood_tear.desc", "en_us")));
...
//val crop8 = <dynamictrees:appleseed> as crafttweaker.item.IIngredient;
//crop8.removeTooltip("Fertile Seasons");
//crop8.removeTooltip("Summer");
//<dynamictrees:appleseed>.addTooltip(game.localize("desc.sereneseasons.fertile_seasons", "en_us"));
//<dynamictrees:appleseed>.addTooltip(format.yellow(game.localize("desc.sereneseasons.summer", "en_us")));
...
<quark:ancient_tome:*>.addTooltip(format.gold(game.localize("item.quark:ancient_tome.desc", "en_us")));
...
<rlmixins:cleansing_talisman>.addTooltip(format.gold(game.localize("item.cleansing_talisman.desc", "en_us")));
...
val crop9 = <rustic:grape_stem> as crafttweaker.item.IIngredient;
crop9.removeTooltip("Fertile Seasons");
crop9.removeTooltip("Spring");
crop9.removeTooltip("Summer");
crop9.removeTooltip("Autumn");
...
<sereneseasons:greenhouse_glass:*>.addTooltip(format.green(game.localize("tile.greenhouse_glass.desc", "en_us")));
...
<simpledifficulty:wool_helmet:*>.addTooltip(format.darkRed(game.localize("tooltip.scripts.simpledifficulty:wool_helmet", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:wool_chestplate.addedtooltip.1", "+2 Warmth");
<simpledifficulty:wool_chestplate:*>.addTooltip(format.darkRed(game.localize("tooltip.scripts.simpledifficulty:wool_chestplate", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:wool_leggings.addedtooltip.1", "+2 Warmth");
<simpledifficulty:wool_leggings:*>.addTooltip(format.darkRed(game.localize("tooltip.scripts.simpledifficulty:wool_leggings", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:wool_boots.addedtooltip.1", "+2 Warmth");
<simpledifficulty:wool_boots:*>.addTooltip(format.darkRed(game.localize("tooltip.scripts.simpledifficulty:wool_boots", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:ice_helmet.addedtooltip.1", "+2 Cooling");
<simpledifficulty:ice_helmet:*>.addTooltip(format.darkAqua(game.localize("tooltip.scripts.simpledifficulty:ice_helmet", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:ice_chestplate.addedtooltip.1", "+2 Cooling");
<simpledifficulty:ice_chestplate:*>.addTooltip(format.darkAqua(game.localize("tooltip.scripts.simpledifficulty:ice_chestplate", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:ice_leggings.addedtooltip.1", "+2 Cooling");
<simpledifficulty:ice_leggings:*>.addTooltip(format.darkAqua(game.localize("tooltip.scripts.simpledifficulty:ice_leggings", "en_us")));
//game.setLocalization("en_us", "item.simpledifficulty:ice_boots.addedtooltip.1", "+2 Cooling");
<simpledifficulty:ice_boots:*>.addTooltip(format.darkAqua(game.localize("tooltip.scripts.simpledifficulty:ice_boots", "en_us")));
...
<spartanweaponry:dagger_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:longsword_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:katana_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:saber_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:rapier_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:greatsword_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:hammer_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:warhammer_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:spear_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:throwing_axe_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:halberd_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:pike_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:lance_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:throwing_knife_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:javelin_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:boomerang_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:battleaxe_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:mace_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:glaive_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
<spartanweaponry:staff_steel:*>.addTooltip(format.gold(game.localize("tooltip.scripts.weapon.steelbonus", "en_us")));
...
<variedcommodities:heart>.addTooltip(format.green(game.localize("item.heart.desc", "en_us")));
...
<variedcommodities:skull>.addTooltip(format.green(game.localize("item.skull.desc", "en_us")));
